...
TOKEN = "I8969898580:AAHxI0_LK57bhCTP_TNYLKubhEU3a0yEg0Y"
...
def handle_callbacks(call):
    ...
    # --- TOGGLE WISHLIST ---
        ...
        # Pulizia robusta valori per il grafico
    ...
    # --- MENU SVINCOLI (FIX) ---
        ...
        if not session['rosa']: 
            bot.answer_callback_query(call.id, "❌ La tua rosa è vuota!", show_alert=True)
            return
